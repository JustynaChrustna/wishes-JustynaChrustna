...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendWishesButton.setOnClickListener {
            ...
            dialogBuilder.setSingleChoiceItems(listItems, -1) { dialogInterface, i ->
    ...
    private fun getWishes(context: Context): Array<String> =
        context.resources.getStringArray(R.array.wishes)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == PICK_CONTACT_REQUEST) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                phoneNumber = phoneNumberRetriever.retrieve(contactData!!)
            }
        }
    }
}
